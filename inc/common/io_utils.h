#ifndef DATASTRUCTURE_INCLUDE_COMMON_IO_UTILS_H_
#define DATASTRUCTURE_INCLUDE_COMMON_IO_UTILS_H_
...
#define PRINT_BOOL(bool_value) \
  PRINTLNF(#bool_value ": %s", bool_value ? "true" : "false")
...
#endif //DATASTRUCTURE_INCLUDE_COMMON_IO_UTILS_H_
